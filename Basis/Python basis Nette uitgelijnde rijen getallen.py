...
# De volgende Python code genereert regels met getallen die uit getallen bestaan van 0 tot en met 100 in verschillende rijen netjes uitgeleind waarbij alle getallen ook nog uit even veel karakters bestaan dus 1 wordt  001 en 100 blijft 100
...
# De volgende Python code genereert regels met getallen die uit getallen bestaan van 0 tot en met 100 in verschillende rijen netjes uitgeleind waarbij alle getallen ook nog uit even veel karakters bestaan dus 1 wordt  001 en 100 blijft 100, waarbij het aantal voorloopnullen afhankelijk is van de range
