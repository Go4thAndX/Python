...
while play_game:
    answer_play_game = input("Do you want to play a game of Blackjack ? ('y' or 'n')")

    if answer_play_game == "y":
        ...
        while card_user:
            ...
            if answer == "y":
                ...
                if user_score > 21:
                    print(print_string_1, user_cards, print_string_2, user_score)
                    print(
                        print_string_3, computer_cards, print_string_4, computer_score
                    )
