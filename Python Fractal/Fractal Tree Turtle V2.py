...
# Flag om de tekenloop te controleren
keep_drawing = True
...
# Luister naar de Esc-toets om te stoppen met tekenen
keyboard.on_press_key('esc', stop_drawing)

# To draw a fractal tree, we use recursion
def draw_fractal_tree(length):
    if keep_drawing and length >= 10:
