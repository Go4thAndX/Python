...
class Boss(Enemy):
    ...
    #override de init van Enemy:
    def __init__(self, name, start_life=20, max_damage=3, shield=3):
        #gebruik hiern de init van Enemy, door de juiste waardes "door te geven"
        Enemy.__init__(self, name, start_life, max_damage)
        
        #en zorg zelf voor het verwerken van de shield
        self.shield = shield
    ...
    def attack(self):
        if self.shield > 0:
            if random.randint(1,2) == 1: #50% kans
                ...
                #gebruik de attack() methode van je parent
                Enemy.attack(self)
